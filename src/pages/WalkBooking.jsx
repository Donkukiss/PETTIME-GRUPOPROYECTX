    ...
    return (
        <div className="relative min-h-screen bg-[#EDF1F6]">
            ...
            <main className="relative z-30 mx-6 mt-6 bg-white rounded-[20px] p-8 shadow-2xl">
                <h1 className="text-[#F29455] text-[22px] font-bold text-center mb-2 mt-[-15px]">Reserva de Paseos</h1>
                <div className="flex flex-col gap-4">
                    ...
                    <div className="relative">
                        <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8A8A8A]" size={20} />
                        <input type="text" placeholder="Fecha y hora de entrega" className="w-full border border-gray-400 rounded-[10px] py-3 pl-12 pr-4 outline-none" />
                    </div>
